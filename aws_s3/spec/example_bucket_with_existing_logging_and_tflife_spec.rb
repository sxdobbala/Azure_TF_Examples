...
describe 'example_bucket_with_logging_and_tflife' do
  ...
  context "example_bucket_with_logging_and_tflife" do
    before (:all) do
      ...
      FileUtils.cp_r(Dir["#{Dir.pwd}/examples/bucket_with_existing_logging_and_tflife/*"],"#{Dir.pwd}/spec/fixtures", )
    end
    ...
    describe 'Verify terraform plan for example bucket_with_existing_logging_and_tflife' do
      before (:all) do
        terraform_plan_output
        @output = terraform_show
      end

      it 'Verify terraform plan for example bucket_with_existing_logging_and_tflife is successful' do
        ...
        expect( @output ).to match(/bucket:\s+"bucket-with-logging-and-tflife-logs"/)
        ...
        expect( @output ).to match(/policy:\s+"{\\n  \\"Version\\": \\"2012-10-17\\",\\n  \\"Statement\\": \[\\n  {\\n      \\"Sid\\": \\"DenyInsecureCommunications\\",\\n      \\"Effect\\": \\"Deny\\",\\n      \\"Action\\": \\"s3:\*\\",\\n      \\"Resource\\": \\"arn:aws:s3:::bucket-with-logging-and-tflife-logs\/\*\\",\\n      \\"Principal\\": \\"\*\\",\\n      \\"Condition\\": {\\n        \\"Bool\\": {\\n          \\"aws:SecureTransport\\": \\"false\\"\\n        }\\n      }\\n    }\\n  \]\\n}\\n"/)
        ...
        expect( @output ).to match(/logging.\d+.target_bucket:\s+"bucket-with-logging-and-tflife-logs-example"/)
