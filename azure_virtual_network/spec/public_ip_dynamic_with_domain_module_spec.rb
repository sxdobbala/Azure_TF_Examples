...
describe 'public_ip_dynamic_with_domain' do
  ...
  it 'should verify the plan output' do
    hcl = %{
      module "dynamic_with_domain" {
        source = "#{__dir__}/../modules/public_ip/dynamic_with_domain"
    ...
    expect(plan_out)
      .to be_terraform_plan
        ...
        .to_destroy(0)
        .with_resources({
            "module.dynamic_with_domain.azurerm_public_ip.public_ip" => {
                "sku" => /"Basic"/,
                "resource_group_name" => /"rg"/,
            ...
            "module.dynamic_with_domain.module.namespace.null_resource.namespace" => {
              "id"=> /<computed>/,
              "triggers.%"=> "3",
              "triggers.format"=> "%s-%s",
            ...
            "module.dynamic_with_domain.module.namespace.random_string.random_string" => {
              "length" => /"12"/,
              "result"=> /<computed>/                
            }
        })
