...
describe 'network_interface_primary_ip_configuration' do
  ...
  it 'should verify the plan output' do
    hcl = %{
      module "primary_ip_configuration" {
        source = "#{__dir__}/../modules/network_interface/primary_ip_configuration"
    ...
    expect(plan_out)
      .to be_terraform_plan
        ...
        .to_destroy(0)
        .with_resources({
          "module.primary_ip_configuration.azurerm_network_interface.network_interface" => {
          ...
          "module.primary_ip_configuration.module.random_dns_label_postfix.random_string.first_char" => {
            "length" => /"1"/,
            "result"=> /<computed>/
          },
          "module.primary_ip_configuration.module.random_dns_label_postfix.random_string.rest_of_string" => {
            "length" => /"7"/,
            "result"=> /<computed>/
          },
          "module.primary_ip_configuration.module.namespace.null_resource.namespace" => {
            "id"=> /<computed>/,
            "triggers.%"=> "3",
            "triggers.format"=> "%s-%s",
          ...
          "module.primary_ip_configuration.module.namespace.random_string.random_string" => {
            "length" => /"12"/,
            "result"=> /<computed>/                
          }
        })
