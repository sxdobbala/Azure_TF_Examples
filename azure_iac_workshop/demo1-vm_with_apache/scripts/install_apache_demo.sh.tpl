#!/bin/bash -x
#
# Run as root - installs apache (with letsencrypt ssl) and creates a hello world page.
...
if [ -e "$$APTGET" ]; then
  ...
  a2dismod -f auth_basic status authn_core autoindex authn_file setenvif negotiation
