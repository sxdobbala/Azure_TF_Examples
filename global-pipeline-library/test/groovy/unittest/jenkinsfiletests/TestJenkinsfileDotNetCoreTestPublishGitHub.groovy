...
class TestJenkinsfileDotNetCoreTestPublishGitHub extends BasePipelineTest implements JPUnittestSupport {
  ...
  void executeJFileWithMockedGLMethods() throws Exception {
    ...
    runScript("Jenkinsfile-DotNetCore_Test_Publish_GitHub")
    printCallStack()
  }
}
