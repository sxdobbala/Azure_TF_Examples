...
class TestJenkinsfileMavenBuildSonarCodehubGit extends BasePipelineTest implements JPUnittestSupport {
  ...
  void executeJFileWithMockedGLMethods() throws Exception {
    ...
    runScript("Jenkinsfile-MavenBuild_Sonar_Codehub-Git")
    printCallStack()
  }
}
