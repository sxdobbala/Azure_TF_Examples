 ...
 *
 *
 * @param scmRepoUrl The URL to the Git repo. If value is provided, must also provide a value for branchName.
 *          Defaults to using Git to find the remote URL.
 * @param branchName The name of the branch. If value is provided, must also provide a value for scmRepoUrl.
 *          Defaults to reading from Git.
