...
export abstract class EntityService<T extends Entity> {
  ...
  protected postCreatePath = "/create";
  protected postUpdatePath = "/update";
  ...
  post(entity: T) {
    this.loadingSubject.next(true);
    return this.httpClient.post(`${this.baseUrl}/${this.entityPath}${this.postCreatePath}`, entity).pipe(
      catchError(this.handleError),
      finalize(() => this.loadingSubject.next(false)),
    );
  }
  ...
  put(entity: T) {
    console.log(entity);
    this.loadingSubject.next(true);
    return this.httpClient.put(`${this.baseUrl}/${this.entityPath}${this.postUpdatePath}`, entity).pipe(
      catchError(this.handleError),
      finalize(() => this.loadingSubject.next(false)),
    );
  }
